...
def model_ui_inputs(input_file_path, uploaded_file, parameter_list, col01):
    ...
    fr_return_dict = fr.fundraisingInput(sys_param, bti_return_dict["equity_investments"], bti_return_dict["equity_perc"], bti_return_dict["public_sale_supply"], bti_return_dict["launch_valuation"], bti_return_dict["initial_supply"], uploaded_file, fundraising_style_map)
