    ...
    with st.expander("**Token Allocations & Vesting**"):
        ...
        with col45:
            ...
            if vesting_style == 'Custom' or show_full_alloc_table:
                ...
                advisor_duration = st.number_input("advisor_duration", label_visibility="collapsed", min_value=0, value=int([(sys_param['advisor_vesting_duration'][0] + sys_param['ov_vesting_duration'][0]) if vesting_style == 'Custom' else duration_dict['advisor']][0]), key="advisor_vesting_duration")
                strategic_partners_duration = st.number_input("strategic_partners_duration", label_visibility="collapsed", min_value=0, value=int([sys_param['strategic_partners_vesting_duration'][0] if vesting_style == 'Custom' else duration_dict['strategic_partners']][0]), key="strategic_partners_vesting_duration")
