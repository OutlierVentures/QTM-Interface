    ...
    with st.expander("**Token Allocations & Vesting**"):
        ...
        with col45:
            ...
            if vesting_style == 'Custom' or show_full_alloc_table:
                ...
                strategic_partners_duration = st.number_input("strategic_partners_duration", label_visibility="collapsed", min_value=0, value=int([sys_param['strategic_partner_vesting_duration'][0] if vesting_style == 'Custom' else duration_dict['strategic_partners']][0]), key="strategic_partner_vesting_duration")
